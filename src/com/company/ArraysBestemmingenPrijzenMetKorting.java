...
public class ArraysBestemmingenPrijzenMetKorting {
    public static void main(String[] args) {
        ...
        if (prijzen[keuze-1] > 300)
            teBetalen = prijzen[keuze-1] * 0.90;  // 10% korting
        else
            teBetalen = prijzen[keuze-1];

        System.out.printf("Dag %s, goede reis naar %s. Dit kost je € %.2f." , naam, bestemmingen[keuze-1], teBetalen);
